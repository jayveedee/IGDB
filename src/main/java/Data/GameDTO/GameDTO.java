...
public class GameDTO {
    ...
    public GameDTO
            (
                ...
                List<Integer> gameCHs, List<Integer> gameACs,
                List<Integer> gameGENREs, List<Integer> gameGMs,
                List<Integer> gameRATINGs, DateDTO gameRELEASEDATE,
                WriterDTO gameWRI,
                DeveloperDTO gameDEV, PublisherDTO gamePUB,
                ComposerDTO gameCOMP, SoundtrackDTO gameOST,
                String gameBIO, int gameAGERATING,
                List<MediaDTO> gameMEDIADTO)
            {
        this.gameID = gameID;
